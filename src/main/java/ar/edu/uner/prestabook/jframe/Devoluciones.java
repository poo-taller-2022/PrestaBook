    ...
    public Devoluciones() {
        ...
        comboBoxPrestamo.addItemListener(e -> {
            ...
            calendarPactadaDevolucion.setDate(prestamo.getFechaPactadaDevolucion() != null
                    ...
                    : null);
            calendarFechaYHoraPrestamo.setDateTimePermissive(prestamo.getFechaYHoraPrestamo() != null
                    ? LocalDateTime.parse(prestamo.getFechaYHoraPrestamo())
                    : null);
        });
        ...
        btnConfirmar.addActionListener(e -> {
            Boolean camposCompletos = textObra.getText() != null &&
                    textEjemplar.getText() != null &&
                    comboBoxLector.getSelectedItem() != null &&
                    textFuncionario.getText() != null &&
