...
public class SistemaFuncionario extends JFrame {
    ...
    public JLabel textUsusario() {
        textUsario = new JLabel("");
        textUsario.setBackground(new Color(0, 128, 0));
        textUsario.setBounds(118, 0, 173, 37);
        textUsario.setFont(new Font("Verdana", Font.BOLD, 16));
        textUsario.setForeground(new Color(255, 255, 255));
        return textUsario;
    }
    ...
    public JButton btnGestionarDevolucion() {
        ...
        btnGestionarDevolucion.setBounds(23, 228, 293, 31);
    ...
    public JButton btnListarLectoresMorosos() {
        ...
        btnListarLectoresMorosos.setBounds(23, 281, 293, 31);
    ...
    public JButton btnMasBuscadasPorAlumnoDocente() {
        ...
        btnMasBuscadasPorAlumnoDocente.setBounds(23, 330, 293, 31);
    ...
    public JButton btnMasBuscadasPorPublicoGeneral() {
        ...
        btnMasBuscadasPorPublicoGeneral.setBounds(23, 383, 293, 31);
    ...
    public JButton btnListarEjemplaresDisponiblesPorArea() {
        ...
        btnListarEjemplaresDisponiblesPorArea.setBounds(23, 438, 293, 31);
    ...
    public JButton btnListarEjemplaresDisponiblesPorFecha() {
        ...
        btnListarEjemplaresDisponiblesPorFecha.setBounds(23, 491, 293, 31);
    ...
    public JButton btnListarLectoresMultadosPorPeriodo() {
        ...
        btnListarLectoresMultadosPorPeriodo.setBounds(23, 548, 293, 31);
    ...
    public JButton btnListarRankingDeMultados() {
        ...
        btnListarRankingDeMultados.setBounds(23, 601, 293, 31);
    ...
    public JButton btnListarObrasPorEditorial() {
        ...
        btnListarObrasPorEditorial.setBounds(23, 657, 293, 31);
    ...
    public JButton btnAplicarMultaALector() {
        ...
        btnAplicarMultaALector.setBounds(23, 711, 293, 31);
    ...
    private void actualizarBaseDeDatos(DefaultTableModel model, String tipoEntidad) {
        ...
        switch (tipoEntidad) {
            ...
            case "Obra":
                ...
                obra.setTipo(new TipoObra(1, null));
                obra.setArea(new AreaTematica(1, null));
