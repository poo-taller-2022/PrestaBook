...
public class Registrarse extends JFrame {
	...
	public Registrarse(Connection conn) {
		...
		JTextField textFechaDeNacimiento = textFechaDeNacimiento();
		...
		btnGuardar.addActionListener(e -> {
				...
				if (Boolean.TRUE.equals(camposCompletos)) {
						...
						String tipoSeleccionado = tipoSeleccionado(btnRadioPublicoGeneral, btnRadioDocente,
								btnRadioAlumno, btnRadioFuncionario);

						Lector lector = crearLector(textNombre, textApellido, textTipoDeDocumento,
								textNumeroDeDocumento, textEmail, textNumeroDeTelefono, textFechaDeNacimiento,
								sexoSeleccionado, textNacionalidad, textDomicilio, textCodigoPostal, textDepartamento,
								textLocalidad, textContrasenia);
	...
	public JTextField textNumeroDeDocumento() {
	...
	public JTextField textFechaDeNacimiento() {
